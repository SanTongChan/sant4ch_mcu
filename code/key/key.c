...
static void key3_long_press(void)
{
    if(dev_def.remote)
    {
        dev_def.dev_channel[2].remote_val = 0;
        RF_LED = 0;
    }
}
static void key4_long_press(void)
{
    if(dev_def.remote)
    {
        dev_def.dev_channel[3].remote_val = 0;
        RF_LED = 0;
    }
}
...
static void registerKeys(void)
{
    ...
    keyRegisterSingle(key3_is_press,key3_short_press,key3_short_up_press,key3_long_press,key3_long_up_press,key3_twice_press);
    keyRegisterSingle(key4_is_press,key4_short_press,key4_short_up_press,key4_long_press,key4_long_up_press,key4_twice_press);
